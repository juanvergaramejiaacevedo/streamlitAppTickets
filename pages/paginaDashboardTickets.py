...
from bd import query_to_df, get_tickets_analytics
...
if 'correo_electronico' in st.session_state:
    ...
    st.subheader('Información | :orange[Dashboard - Tickets (General)]')
    
    #st.markdown("""
    #> ## Dashboard - Tickets
    #""")
    tickets_df = get_tickets_analytics()
    if tickets_df.empty:
        st.info("No hay tickets registrados.")
    else:
        
        st.markdown("""> ## Datos - Tickets""")
