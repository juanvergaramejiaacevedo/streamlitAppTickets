...
from bd import query_to_df, get_tickets_analytics_sopext
...
if 'correo_electronico' in st.session_state:
    ...
    st.subheader('Información | :orange[Dashboard - Tickets (Soporte Externo)]')
    
    #st.markdown("""
    #> ## Dashboard - Tickets
    #""")
    tickets_df = get_tickets_analytics_sopext()
    if tickets_df.empty:
